...
$(document).ready(function(){
    ...
    $( "#save" ).click(function() {
        ...
        var zip = $("#zip").val();
        var dob = $("#dob").val();
        var associate_array={'email':email,'phone':phone,'zip':zip,'dob':dob};
        if ( email === "" ||
        ...
        if ( isValid ) {
            ...
            var html='';
          for(var index in associate_array) {
              sessionStorage.index = associate_array[index];
              html+=index + "=" + associate_array[index] + "|";
              console.log( html);
          }
           sessionStorage.profile=html;
